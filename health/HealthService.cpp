 ...
 */
#define LOG_TAG "android.hardware.health@2.0-service.lavender"
...
using ::device::xiaomi::lavender::health::BatteryRechargingControl;
using ::device::xiaomi::lavender::health::BatteryInfoUpdate;
using ::device::xiaomi::lavender::health::LearnedCapacityBackupRestore;
