...
/* Lavender doesnt have trip sensor but i not remove this for future usage on other's devices*/
...
/*
 * Lavender don't offline CPU, so std::thread::hardware_concurrency(); should work.
